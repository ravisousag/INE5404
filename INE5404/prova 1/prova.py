        ...
        while True:
            ...
            while True:
                try:
                    ...
                    print('\033[31mNão aceita letras!\033[m')
...
class Carro(Prova):
    def __init__(
        self, placa, ano, categoria, transmissao, combustivel, marca, modelo, aluguel
    ):
        self.placa = placa
        self.ano = ano
...
class Cliente(Prova):
    ...
    def novo_cliente(self):
        ...
        usuario = {"nome": self.nome, "cpf": self.cpf, "rg": self.rg}
